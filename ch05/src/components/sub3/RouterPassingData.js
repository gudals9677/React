...
const RouterPassingData = () => {
    ...
    return (
        <div>
            <form>
                <input type="text" name="uid" value={formData.uid} onChange={inputChangeHandler} />
                <br />
                <input type="text" name="name" value={formData.name} onChange={inputChangeHandler} />
                <br />
                <input type="number" name="age" value={formData.age} onChange={inputChangeHandler} />
                <br />
